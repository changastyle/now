...
public class AbstractDAO 
{
    ...
    public static ArrayList<Object> findAllByHQL(String hql)
    {
        ...
        try 
        {
            Query query = session.createQuery(hql);   //System.out.println("AbstractDAO.findAll("+  sql + ") -> sql común: " + sql);
    ...
    public static Object getByHQL(String hql) 
    {
    ...
    public static boolean searchOneAndDelete(Class clase , int id)
    {
        return daos.AbstractDAO.deleteOne(get(clase, id));
    }
